...
function haberYapici(haber) {
  ...
  //bir haber butonuna basılınca açık olan diğer haberi kapatıyor.

  btn.addEventListener("click", (event) => {
    if (
      document.querySelector(".article-open") !== null &&
      !event.target.parentElement.classList.contains("article-open")
    ) {
  ...
  //Hangi haber butonuna basılırsa o açılır, diğerine basılınca o da açılır ve hepsi açık kalabilir.
